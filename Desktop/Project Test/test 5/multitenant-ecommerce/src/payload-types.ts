...
export interface Tenant {
  id: string;
  /**
   * This is the name of the store (e.g. Chinavit's Shop)
   */
  name: string;
  /**
   * This is the subdomain of the store (e.g. [slug].Central Art.com)
   */
  slug: string;
  image?: (string | null) | Media;
  /**
   * Stripe Account ID asscoiated with your shop
   */
  stripeAccountId: string;
  /**
   * You cannot create products or process orders until you have submitted your Stripe details.
   */
